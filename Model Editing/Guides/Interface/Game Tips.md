...
Create your new line, here is my example :

1 : ID, must be unique, mine is 510.  
2 : |cffffd100Astuce :|r : It means the word "Astuce" (means trick) will be colored in Gold. I call the color through |cffffd100 and I close my color by |r.
...
- **Author**: Oldarorn
- [Model Changing](https://model-changing.net/index.php?app=tutorials&module=tutorials&controller=view&id=34)
